...
export const translations: Translations = {
	strings: {
		...
		"You are already ignoring help ticket notifications. Use /helpticket unignore to receive notifications again.": "Ya estás ignorando las notificaciones de los help tickets. Usa /helpticket unignore para recibir notificaciones nuevamente.",
		"You are now ignoring help ticket notifications.": "Estás ignorando ahora las notificaciones de los help tickets.",
		"You are not ignoring help ticket notifications. Use /helpticket ignore to stop receiving notifications.": "Ya no estás ignorando las notificaciones de los help tickets. Usa /helpticket ignore para no recibir notificaciones.",
		"You will now receive help ticket notifications.": "Ahora no recibirás notificaciones de help tickets.",
		"${target} does not have a ticket.": "${target} no tiene un ticket.",
		"You deleted ${target}'s ticket.": "Tú eliminaste el ticket de ${target}",

		"Hi! All global staff members are busy right now and we apologize for the delay. ": "Hola! Todos los miembros del Staff estan ocupados en este momento, pedimos disculpas por la demora",
